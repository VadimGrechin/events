		...
		uk: {
			message: {
				...
				registrationForm: {
					...
					registrationSuccessAdd: 'Незабаром Ви отримаєте електронного листа з підтверженням, в якому будуть вказані деталі, які Вам потрібно знати про подію.<br>Ми з нетерпінням чекаємо на зустріч з Вами.',
